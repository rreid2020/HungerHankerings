...
# Prefer one-line SSL config (avoids "__" keys some platforms strip). start.sh applies this by default when DB_SSL is unset or "true":
# DB_SSL=json:{"rejectUnauthorized":false}
```
