...
const postal_zone_shop_api_extensions_1 = require("./api/postal-zone-shop-api.extensions");
const postal_zone_admin_resolver_1 = require("./api/postal-zone-admin.resolver");
const postal_zone_shop_resolver_1 = require("./api/postal-zone-shop.resolver");
...
function postalZoneAdminSchema() {
    ...
    return parse(postal_zone_api_extensions_1.postalZoneAdminSchemaSdl);
}
function postalZoneShopSchema() {
    const { parse } = require("graphql");
    return parse(postal_zone_shop_api_extensions_1.postalZoneShopSchemaSdl);
}
/**
...
exports.PostalZonePlugin = PostalZonePlugin = __decorate([
    (0, core_1.VendurePlugin)({
        ...
        shopApiExtensions: {
            ...
            resolvers: [postal_zone_shop_resolver_1.PostalZoneShopResolver],
        },
