...
exports.regionShippingCalculator = exports.regionShippingEligibilityChecker = void 0;
const core_1 = require("@vendure/core");
/**
 * Eligibility: all orders with a shipping address are eligible.
 */
exports.regionShippingEligibilityChecker = new core_1.ShippingEligibilityChecker({
    code: "region-shipping-eligibility",
    description: [
        { languageCode: core_1.LanguageCode.en, value: "Region-based shipping" },
    ],
    args: {},
    check: (_ctx, order) => {
...
exports.regionShippingCalculator = new core_1.ShippingCalculator({
