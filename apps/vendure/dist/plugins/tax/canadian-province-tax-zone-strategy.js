...
exports.canadianProvinceTaxZoneStrategy = void 0;
/**
...
function normalizeCanadianProvince(province) {
 ...
 */
exports.canadianProvinceTaxZoneStrategy = new (class {
    determineTaxZone(ctx, zones, channel, order) {
        ...
        if (!order?.shippingAddress)
            return defaultZone;
        const countryCode = order.shippingAddress.countryCode?.toUpperCase();
