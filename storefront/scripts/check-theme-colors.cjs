 ...
 * Run: node scripts/check-theme-colors.cjs  or  pnpm run check-theme
 */
...
const FORBIDDEN_PATTERNS = [
  ...
  /* Legacy palettes and brand-50..900 allowed during migration; re-enable to enforce semantic-only:
