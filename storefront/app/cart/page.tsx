          ...
          <div className="flex justify-between text-foreground">
            <dt className="flex items-center gap-1">
              ...
              <span className="text-muted-foreground" title="Shipping calculated at checkout">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4" aria-hidden>
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-.A1 1 0 0110 7zm-1 4a1 1 0 100 2 1 1 0 000-2zm3-1a1 1 0 011 1v.581a2 2 0 001.106 1.789l.5.25a2 2 0 001.106 1.789V14a1 1 0 11-2 0v-.581a2 2 0 00-1.106-1.789l-.5-.25A2 2 0 0011 8.419V7a1 1 0 011-1z" clipRule="evenodd" />
                </svg>
              </span>
            </dt>
